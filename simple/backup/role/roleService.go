...
func (this *Role) Register(c server.Controller, msg net.GetPacket) {

}
func (this *Role) Login(c server.Controller, msg net.GetPacket) {
	//反序列化
...
func (this *Role) LoginOut(c server.Controller, msg net.GetPacket) {
